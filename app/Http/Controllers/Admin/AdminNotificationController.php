...
class AdminNotificationController extends Controller
{
    public function index(Request $request): View
    {
        ...
        $notifications = (clone $baseQuery)->with(['order.statusHistories'])
        ...
        return view('admin.notifications.index', compact('notifications', 'notificationStats', 'categories', 'activeView', 'currentUser', 'deliverySummary', 'recentDeliveries', 'channelHealth'));
    }
