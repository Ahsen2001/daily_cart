...
<div style="max-width: 680px; margin: 0 auto; font-family: Arial, sans-serif; color: #27312b; line-height: 1.55;">
    <div style="padding: 28px; background: #0f7a3a; color: #ffffff; border-radius: 18px 18px 0 0;">
        ...
        <h1 style="margin: 8px 0 0; font-size: 26px;">Your order is successfully deliverd</h1>
    ...
    <div style="padding: 28px; border: 1px solid #dceee1; border-top: 0; border-radius: 0 0 18px 18px; background: #ffffff;">
        ...
        <p>Your order is successfully deliverd. Here is your itemized invoice for this delivery.</p>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="font-size: 14px;">
            ...
            <tr style="font-size: 18px; font-weight: 700;">
                <td style="padding-top: 14px; border-top: 1px solid #bcdcc5;">Total</td>
                <td style="padding-top: 14px; border-top: 1px solid #bcdcc5; text-align: right;">{{ CurrencyService::formatLkr($order->total_amount) }}</td>
            </tr>
        </table>
