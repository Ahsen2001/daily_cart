...
<div {{ $attributes->class([
    ...
    <div class="{{ $stacked ? 'flex flex-col gap-2' : 'flex items-start gap-3' }}">
        ...
        <div class="min-w-0 flex-1">
            ...
            <p class="mt-1 break-normal text-sm font-semibold leading-6 text-brand-text">{{ $address ?: __('Address not provided') }}</p>
            @if ($hasCoordinates)
