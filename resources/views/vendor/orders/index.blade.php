<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="text-xl font-semibold leading-tight text-gray-800">{{ __('Vendor Orders') }}</h2>
            <a href="{{ route('vendor.orders.earnings') }}" class="text-sm font-medium text-indigo-700 underline">{{ __('Earnings') }}</a>
        </div>
    </x-slot>
